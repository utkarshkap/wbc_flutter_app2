...
class _StocksReviewState extends State<StocksReview> {
  ...
  List<String> stocksType = ['CDSL', 'NSDL'];
        ...
        body: Padding(
          ...
          child: BlocConsumer<ReviewBloc, ReviewState>(
            listener: (context, state) {
              if (state is UploadStockReviewFailed) {
                isSend = false;
                AwesomeDialog(
              ...
              } else if (state is UploadStockDataAdded) {
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                                  ...
                                  bottomActions: [
                                    ...
                                    ProgressBar(
                                      ...
                                      colors: ProgressBarColors(
                                        backgroundColor: colorWhite,
                                        bufferedColor: colorRed.withOpacity(
                                          0.5,
                                        ),
                                      ),
                                    ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Learn To Download Stock Statement',
                    ...
                    if (fileValidation.isNotEmpty) SizedBox(height: 0.5.h),
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Padding(
                        padding: EdgeInsets.only(left: 2.w),
