...
class _StocksInvestmentState extends State<StocksInvestment> {
  ...
  int totalQty = 0;
  bool othersbrokerHoldingsData = false;
  double otherTotalHoldingQty = 0;
  double otherTotalHoldingAmount = 0;
  ...
  Widget build(BuildContext context) {
    if (othersbrokerHoldingsData == false) {
                    ...
                    return Stack(
                      ...
                      children: [
                          ...
                          children: [
                                                        ...
                                                        setState(() {
                                                          ...
                                                          if (selectedType ==
                                                            ...
                                                            BlocProvider.of<
                                                                        FetchingDataBloc>(
                                                                    context)
                                                                .add(GetBrokerholdingsEvent(
                                                                    holdings: GetBrokerHoldingModel(
                                                                        code: 0,
                                                                        message:
                                                                            '',
                                                                        data: [])));
                            ...
                            InkWell(
                                onTap: () {
                                  ...
                                  Navigator.of(context)
                                      .pushNamed(ConnectBrokers.route);
                                },
                                child: Container(
                                  height: 6.5.h,
                                  width: 90.w,
                        ...
                        Positioned(
                            top: 20.5.h,
                            child: Container(
                              height: state.stockInvestmentPortfolio.stocks
                                      .isNotEmpty
                                  ? 52.5.h
                                  : 0,
                              width: 90.w,
                              ...
                              child: Column(children: [
                                Expanded(
                                  flex: 6,
                                  child: ListView.builder(
                                      itemCount: state.stockInvestmentPortfolio
                                          .stocks.length,
                                                ...
                                                children: [
                                                  reviews(
                                                      ...
                                                      state
                                                          ...
                                                          .toStringAsFixed(2),
                                                      () => {
                                                            BlocProvider.of<StockTransactionBloc>(context).add(LoadStockTransactionEvent(
                                                                userId: ApiUser
                                                                    .userId,
                                                                stockName: state
                                                                    .stockInvestmentPortfolio
      ...
      return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: Scaffold(
              ...
              body: BlocConsumer<FetchingDataBloc, FetchingDataState>(
                listener: (context, state) {
                  if (state is GetHoldingsDataFailed) {
                    AwesomeDialog(
                      btnCancelColor: colorRed,
                      padding: EdgeInsets.zero,
                      context: context,
                ...
                builder: (context, state) {
                  if (state is GetHoldingsDataInitial) {
                    return Center(
                      child: SizedBox(
                          height: 25,
                          width: 25,
                  ...
                  if (state is GetHoldingsDataLoaded) {
                    otherTotalHoldingQty = 0;
                    otherTotalHoldingAmount = 0;
                    for (int i = 0;
                        i < state.getBrokerHoldings.data!.length;
                        i++) {
                      otherTotalHoldingQty +=
                          state.getBrokerHoldings.data![i].quantity!.toDouble();
                      otherTotalHoldingAmount += (state
                              .getBrokerHoldings.data![i].quantity!
                              .toDouble() *
                          state.getBrokerHoldings.data![i].rate!.toDouble());
                    }
                    isCalculateInvestments = true;
                    return Stack(
                      alignment: Alignment.topCenter,
                      ...
                      children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Text(
                                                      '₹${CommonFunction().splitString(otherTotalHoldingAmount.toStringAsFixed(0))}',
                                                      style: textStyle22(
                                                              colorWhite)
                                                          .copyWith(
                                                              height: 1.2)),
                        ...
                        Positioned(
                            top: 15.5.h,
                            child: Container(
                              height: state.getBrokerHoldings.data!.isNotEmpty
                                  ? 52.5.h
                                  : 0,
                              width: 90.w,
                              decoration: decoration(),
                              child: Column(children: [
                                Expanded(
                                  ...
                                  child: ListView.builder(
                                      itemCount:
                                          state.getBrokerHoldings.data!.length,
                                      itemBuilder: (context, index) {
                                        return Column(
                                          children: [
                                            reviews(
                                                state.getBrokerHoldings
                                                    .data![index].symbol
                                                    .toString(),
                                                state.getBrokerHoldings
                                                    .data![index].quantity
                                                ...
                                                () => {},
                                                state.getBrokerHoldings
                                                    .data![index].brokerName!
                                                    .split(' ')[0]),
                                            if (index !=
                                                state.getBrokerHoldings.data!
                                                        .length -
                                                    1)
                                              Container(
                                                  height: 1,
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${CommonFunction().splitString(otherTotalHoldingQty.toStringAsFixed(0))}',
                                                  style: textStyle11Bold(
                                                      colorBlack),
                                                  maxLines: 1,
                                                  overflow:
  ...
  reviews(String title, String value, Color textColor, var percentageVal,
      Function() onClick,
      [String? brokerName]) {
    return Padding(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Column(
                ...
                children: [
                  SizedBox(
                      width: 65.w,
                      child: Text(
                          "$title ${brokerName == null || brokerName == 'null' ? '' : '- $brokerName'}",
              ...
              Column(
                children: [
                  Text(CommonFunction().splitString(percentageVal.toString()),
