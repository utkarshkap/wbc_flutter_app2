...
class WealthMeterData {
  ...
  num spouseIncome;
  num otherIncome;
  num houseHoldMonthly;
  num totalMonthlyEmi;
  num totalInsurancePremiumYearly;
  num childrenEducationYearly;
  num otherExpenseYearly;
  num vehicle;
  num gold;
  num savingAccount;
  num cash;
  ...
  num guided;
  num unguided;
  num postOfficeOrVikasPatra;
  num pMS;
  num privateInvestmentScheme;
  num realEstate;
  num termInsurance;
  num traditionalInsurance;
  num uLIP;
  num vehicleInsurance;
  num otherInsurance;
  num healthInsurance;
  num housingLoan;
  num mortgageLoan;
