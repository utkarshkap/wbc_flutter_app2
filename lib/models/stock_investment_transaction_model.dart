...
StockInvestmentTransactionModel stockInvestmentTransactionFromJson(
        String str) =>
    StockInvestmentTransactionModel.fromJson(json.decode(str));

String stockInvestmentTransactionToJson(StockInvestmentTransactionModel data) =>
...
class StockInvestmentTransactionModel {
  ...
  factory StockInvestmentTransactionModel.fromJson(Map<String, dynamic> json) =>
      StockInvestmentTransactionModel(
        code: json["code"],
        message: json["message"],
        stockTransactions: json["stockTransactions"] == null
            ? []
            : List<StockTransactions>.from(json["stockTransactions"]
                .map((x) => StockTransactions.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "message": message,
        "stockTransactions":
            List<dynamic>.from(stockTransactions.map((x) => x.toJson())),
      };
...
class StockTransactions {
  ...
  factory StockTransactions.fromJson(Map<String, dynamic> json) =>
      StockTransactions(
