...
class EMISIPCalculatorBloc extends Bloc<EMISIPCalculatorEvent, EMISIPCalculatorState> {
    ...
    on<EMISIPData>((event, emit) async {
      ...
      await Future.delayed(const Duration(seconds: 3), () async {
        ...
        final response = await emiSipCalRepo.setSIPCalculator(
          ...
          loanInterestRate: event.noOfYear,
        ...
        response.statusCode == 200
          ...
          emiAmount: data.emiAmount.toString(), sipAmount: data.sipAmount.toString(),
